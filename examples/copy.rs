...
// TODO: customize for concurrent chromosome identification
lazy_static! {
  static ref ELEMENTS: [Elem; 4] = [
  // static ref ELEMENTS: [Elem; 9] = [
    Elem {
      indent: 0,
      index: 0,
      progress_bar: ProgressBar::new(100),
      key: "Setting Configuration".to_string()
    },
    Elem {
      indent: 0,
      index: 0,
      progress_bar: ProgressBar::new(100),
      key: "Running Reference Genome module".to_string()
    },
    Elem {
      indent: 0,
      index: 0,
      progress_bar: ProgressBar::new(100),
      key: "Running Chromosomal Loci module".to_string()
    },
    Elem {
      indent: 0,
      index: 0,
      progress_bar: ProgressBar::new(100),
      key: "Running Peak Identification module".to_string()
    },
    // Elem {
    //   indent: 2,
    //   index: 2,
